      ...
      <header className="w-full h-[125px] lg:w-[125px] bg-periwinkle lg:h-[100vh] left-0 flex lg:flex-col fixed">
        <div className="flex items-center justify-center h-full lg:h-1/6 md:w-1/6 lg:w-full w-0 invisible md:visible">
          <img
            src={Logo}
            alt="Logo"
            className="h-[100px] w-[100px] lg:w-full"
          />
        </div>
        ...
        <nav className="h-full w-3/4 md:w-4/6 flex lg:flex-col lg:w-full lg:h-4/6 justify-center items-center">
          <ul className="grid grid-cols-3 md:flex lg:flex-col w-full h-full justify-center">
            <Link to={"/"}>
              <li
                className="h-full lg:h-auto w-full text-blanco px-4 lg:py-4 flex flex-col items-center justify-center hover:text-tropical-indigo hover:bg-blanco transition-all
               duration-500"
              >
            ...
            <Link to={"/add"}>
              ...
              >
                ...
                <h3 className="text-lg font-semibold font-Open-Sans">
                  Agregar
                </h3>
              </li>
            </Link>
        ...
        <div className="h-full w-1/4 md:w-1/6 lg:h-1/6 lg:w-full flex items-center lg:items-end">
          <button
            className="h-auto w-full text-blanco px-4 lg:px-0 lg:py-4 flex flex-col items-center justify-center"
            onClick={(e) => {
              logout()
            }}
          >
